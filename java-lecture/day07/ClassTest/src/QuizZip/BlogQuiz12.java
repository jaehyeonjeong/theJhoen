...
public class BlogQuiz12 {
    //    12. 간단한 콘서트 예약 시스템을 만들어보자. 다수의 클래스를 다루고 객체의 배열을
//    다루기  에는 아직 자바 프로그램 개발이 익숙하지 않은 초보자에게 다소 무리가 있을 것이다.
...
//- 없는 이름, 없는 번호, 없는 메뉴, 잘못된 취소 등에 대해서 오류 메시지를 출력하고
//    사용자가 다시 시도하도록 한다.
//
//    명품콘서트홀 예약 시스템입니다.
